...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.ambientLightR = 0.3, this.ambientLightG = 0.3, this.ambientLightB = 0.3;
    }
    initLights() {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(1, 1, 1, 1.0);
        this.material4.setDiffuse(0.5, 0.25, 0.0, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.ambientLightR, this.ambientLightG, this.ambientLightB, 1);
