...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		*/
		...
		this.waterMainTexture = new CGFtexture(this, "textures/waterTex.jpg");
	...
	update(t) {
		...
		if(this.selectedExampleShader == 11){
			this.testShaders[11].setUniformsValues({offset: t%10000});
		}
	}
	...
	display() {
		...
		this.waterMainTexture.bind();
		this.waterAuxTexture.bind(1);
